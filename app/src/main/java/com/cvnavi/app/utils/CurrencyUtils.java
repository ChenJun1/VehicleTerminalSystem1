...
public final class CurrencyUtils {
    ...
    public static boolean test(int code) {
        ...
        if (code % 10000 / 10 == 0)
            return false;
        return code / 10000 != 0 && hashMap.get(code) != null;
    }
    ...
    public static String getProvince(int code) {
        return hashMap.get(code * 10000) != null ? hashMap.get(code * 10000) : "";
    }
     ...
     */
    public static String getCity(int provinceCode, int code) {
        int allCode = Integer.parseInt(provinceCode + addZeroForNum(String.valueOf(code), 4));
        return hashMap.get(allCode) != null ? hashMap.get(allCode) : "";
    }
    ...
    public static String getProvinceId(String value) {
        String key = null;
        //Map,HashMap并没有实现Iteratable接口.不能用于增强for循环.
        for (int getKey : hashMap.keySet()) {
    ...
    public static String getCityId(String provinceId, String value) {
        String key = null;
        for (int getKey : hashMap.keySet()) {
            if (hashMap.get(getKey).equals(value)) {
                if (String.valueOf(getKey).substring(0, 2).equals(provinceId)) {
                    key = String.valueOf(getKey);
                }
            }
        }
        if (key != null) {
            return key.substring(2, 6);
        }
        return "";
    }
    ...
    public static int getCodeByColor(String color) {
        int code=0;
        switch (color) {
            case "蓝色":
                code = 1;
