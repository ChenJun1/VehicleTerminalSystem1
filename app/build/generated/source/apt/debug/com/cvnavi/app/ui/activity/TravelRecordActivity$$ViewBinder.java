...
public class TravelRecordActivity$$ViewBinder<T extends TravelRecordActivity> extends ToolbarActivity$$ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends TravelRecordActivity> extends ToolbarActivity$$ViewBinder.InnerUnbinder<T> {
    View view2131558539;
