...
public class DrivingScoreFragment2Adapter$ViewHolder$$ViewBinder<T extends DrivingScoreFragment2Adapter.ViewHolder> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131558869, "field 'mSerialNumberTv'");
    target.mSerialNumberTv = finder.castView(view, 2131558869, "field 'mSerialNumberTv'");
    view = finder.findRequiredView(source, 2131558870, "field 'mBeginTimeTv'");
    target.mBeginTimeTv = finder.castView(view, 2131558870, "field 'mBeginTimeTv'");
