...
public class EquipmentDetectionActivity$$ViewBinder<T extends EquipmentDetectionActivity> extends ToolbarActivity$$ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558592, "field 'mTablayout'");
    target.mTablayout = finder.castView(view, 2131558592, "field 'mTablayout'");
    view = finder.findRequiredView(source, 2131558591, "field 'mToolbarLayuot'");
    target.mToolbarLayuot = finder.castView(view, 2131558591, "field 'mToolbarLayuot'");
    return unbinder;
  }
