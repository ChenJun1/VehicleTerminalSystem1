...
public class DrivingScoreFragment2$$ViewBinder<T extends DrivingScoreFragment2> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131558713, "field 'mAllTimeTv'");
    target.mAllTimeTv = finder.castView(view, 2131558713, "field 'mAllTimeTv'");
    view = finder.findRequiredView(source, 2131558714, "field 'mAllMileTv'");
    target.mAllMileTv = finder.castView(view, 2131558714, "field 'mAllMileTv'");
    view = finder.findRequiredView(source, 2131558715, "field 'mAllOilConsumptionTv'");
    target.mAllOilConsumptionTv = finder.castView(view, 2131558715, "field 'mAllOilConsumptionTv'");
    view = finder.findRequiredView(source, 2131558716, "field 'mAverageOilConsumption2Tv'");
    target.mAverageOilConsumption2Tv = finder.castView(view, 2131558716, "field 'mAverageOilConsumption2Tv'");
